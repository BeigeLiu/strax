...
DIGITAL_SUM_WAVEFORM_CHANNEL = -1#np.linspace(0,8,8,dtype=np.int16)
DEFAULT_RECORD_LENGTH = 400
...
def peak_dtype(n_channels=100, n_sum_wv_samples=100, n_widths=11, digitize_top=True, hits_timing=True):
